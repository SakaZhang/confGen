...
type BlackboxExporterCsv struct {
	BaseStruct
}

func (u BlackboxExporterCsv) ToCSV() ([]string, error) {
	var csv []string
...
func (u *BlackboxExporterCsv) UnmarshalYAML(value *yaml.Node) error {
	tmp := getLastConf("blackbox_exporter")
